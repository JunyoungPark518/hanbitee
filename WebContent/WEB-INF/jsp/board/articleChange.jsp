	...
	<div id="wrapper" class="width100" style="height: 80px; border-top: 2px solid darkgray;">
		...
		<div>
			<table class="bbs_one">
				<tr>
					...
					<td><input type="text" name="title" value="<%= temp.getTitle() %>" style="width:160px"/></td>
					<td style="width:200px"><b style="margin-left: 1px solid black;">자유 게시판</b></td>
				</tr>
				<tr>
					<td colspan="2">작성자: <%= temp.getId() %></td>
					<td>주소부분</td>
				</tr>
				<tr>
					<td colspan="3"><span style="margin-top:10px; margin-bottom:10px">
					<input type="text" name="content" value="<%= temp.getContent() %>" style="height: 300px; width: 600px"/>
					</span></td>
				</tr>
			</table>
		</div>
		<div style="margin-top:30px; text-align:right">
			<table style="width:60%; margin: 0 auto">
				<tr>
				<td><a href=""><input  type="submit" name="change" value="수정 완료"/></a>
