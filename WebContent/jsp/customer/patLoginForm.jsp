			...
			<div>
				<table style="margin: 0 auto;">
					<tr>
						<td>
						<div>
						<form action="patLogin.jsp" method="post">
						<table class="login_table">
							<tr>
								<td><input type="text" name="id" placeholder="아이디" class="login_input" style="border-bottom: 1px solid #cccccc;" /></td>
								<td rowspan="2" class="login_btn"><input type="submit" name="login" value="로그인" class="login_input" style="width: 60px; height: 40px;" /></td>
							</tr>
							<tr>
